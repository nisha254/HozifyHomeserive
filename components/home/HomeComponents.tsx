...
export const CustomServiceGrid = ({ onNavigate }: any) => {
  const GRID_ITEMS = [
    { title: "Women's Salon &\nSpa", id: '2', icon: 'https://img.freepik.com/free-photo/woman-washing-head-hairsalon_1157-27179.jpg' },
    { title: "Men's Salon &\nMassage", id: 'men-salon', icon: 'https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=600&h=400&fit=crop&crop=center' },
    { title: 'Home\nCleaning', id: '1', icon: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=120' },
    { title: 'AC & Appliance\nRepair', id: '5', icon: 'https://images.unsplash.com/photo-1621905251918-48416bd8575a?w=120', time: '44 mins', sale: true },
    // { title: 'Electrician', id: '3', icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNn-2Ghxi4PF2gbtgYh3ogpHr2N_JnJSIb0Ej8GKYUDAm3_MarK7scigZo_xW7KVVi7xKF-FvedZbjD6bJl1GDFVA&s&ec=121630504', time: '44 mins' },
...
const styles = StyleSheet.create({
  ...
  gridIcon: { width: '90%', height: '90%', resizeMode: 'contain', borderRadius: 18 },
